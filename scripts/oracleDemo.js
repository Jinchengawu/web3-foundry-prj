...
async function main() {
    ...
    const price3 = ethers.utils.parseEther("1.5"); // 1.5 ETH
    ...
    // 更新价格3
    console.log("更新价格到:", ethers.utils.formatEther(price3), "ETH");
    await oracle.updatePrice(price3);
    ...
    try {
        await oracle.updatePrice(initialPrice);
        console.log("错误：暂停状态下仍能更新价格");
    } catch (error) {
        console.log("正确：暂停状态下无法更新价格");
    }
